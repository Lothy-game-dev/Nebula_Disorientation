...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDataDatabase()
    {
        ...
        string ArsenalWeapon = "INSERT INTO ArsenalWeapon VALUES " +
            ...
            "(4, 'Thermal', 'Nano Flame Thrower', 'A thermal weapon that emits a straight beam of yellow flames. <br>Detailed: Dealing multiple instances of dmg, limited at RoF instance of dmg per second.', 'OH-0.067,4,15|DPH-12.5|RoF-150|AoE-0|V-750|R-500', '2000', '25', null, 1, '#36b37e', 'Orange', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>DADDD - A thermal weapon that emits a straight beam of yellow flames. <br>Detailed: Dealing multiple instances of dmg, limited at RoF instance of dmg per second.')," +
