...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string Enemy = "INSERT INTO Enemies VALUES " +
            ...
            "(7, 'ZatWR-MK3', 'WSSS', 'GravitationalArtillery', 'HP-14400|SPD-400|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK3 version of the ZatWR gets sturdier Vehicle Structure Health at the cost of Movement Speed.', '#4c9aff')," +
            "(8, 'ZatWR-MKL', '', 'AdvancedLaserCannon|OrbOfVaccumGenerator', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-0.8', 'FortifiedBarrier|EnhancedShortLaserBeam', 'N', 'MKL version - the most refined prototype of the ZatWR. It has an advanced Power Activating Module that lowers Power Cooldown and equipped with Enhanced Short Laser Beam as a 2nd Power. However, its turning speed is quite sluggish. ', '#4c9aff')," +
            ...
            "(10, 'KazaT-MK2', '', 'FreezingBlaster', 'HP-9600|SPD-600|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK2 version of the KazaT exchanges Vehicle Structure Health for Faster Movement Speed.', '#4c9aff')," +
            ...
            "(12, 'KazaT-MKL', '', 'AdvancedFreezingBlaster|OrbOfLavaGenerator', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-0.8', 'FortifiedBarrier|EnhancedShortLaserBeam', 'N', 'MKL version - the most refined prototype of the Kazat. It has an advanced Power Activating Module that lowers Power Cooldown and equipped with Enhanced Short Laser Beam as a 2nd Power. However, its turning speed is quite sluggish.', '#4c9aff')," +
            "(13, 'Zaturi-Prot No.1', 'WSSS', 'NanoCannon|SuperiorLaserCannon', 'HP-15000|SPD-500|ROT-1.25|AOF-120,120|DM-1.15|AM-1.0|PM-0.5', 'HeavyBarrier|SuperiorShortLaserBeam', 'N', 'Zaturi-Prototype No 1 is the first Elite Fighter Prototype by the Zaturi, with better overall characteristics compared to all lower-grade Fighters. It is extremely flexible at turning, having a wider  Arc of Fire. On the other hand, it also has great Firepower Damage Implementation & the best Power Activating Module, together with Heavy Barrier & Superior Short Laser Beam equipped.', '#bf2600')," +
            "(14, 'Zaturi-Ranger', '', 'GrandGravitationalArtillery', 'HP-5000|SPD-400|ROT-0.25|AOF-45,45|DM-1.2|AM-3.0|PM-1.0', 'HeavyBarrier|SuperiorRocketBurstDevice', 'N', 'Zaturi-Ranger is the second version of the Elite Fighter Prototypes by the Zaturi. It possesses awesome Firepower Damage Implementation & superior Firepower Area of Effect Implementation, at the cost of both Vehicle Structure Health and Movement Speed. Its Powers are Heavy Barrier & Superior Rocket Burst Device.', '#bf2600')," +
            "(15, 'Zaturi-Warmonger', '', 'SuperiorFreezingBlaster|PlasmaCannon', 'HP-20000|SPD-600|ROT-1|AOF-60,60|DM-1.25|AM-1.0|PM-0.8', 'HeavyBarrier|AdvancedInstantWormhole', 'N', 'Zaturi-Warmonger is the third version of the Elite Fighter Prototypes by the Zaturi. It is the most fearsome Zaturi Fighter, with fantastic overall attributes. Additionally, it also possesses advanced Power Activating Module, with Heavy Barrier & Advanced Instant Wormhole equipped.', '#bf2600');";
        // Warship
