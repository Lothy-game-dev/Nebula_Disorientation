...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDataDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            "(1, 'DEF', 'Situational Barrier', 'Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br>Base Barrier HP = Default Barrier HP Fighter ', 'BR-x2|DC-10,20', '0', '0', null, 1, '#36b37e', 'Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br>Base Barrier HP = Default Barrier HP Fighter ')," +
        ...
        string Warship = "INSERT INTO Warship VALUES" +
            ...
            "(3, 'Zat-Cruiser', 'Cruisers are among the advanced Warships out there, they are are the first ones to equip double Main Weapons.', 'HP-600000|SPD-175|ROT-0.2', '#4c9aff', 'Zaturi Grand Beam Cannon|Zaturi Grand Beam Cannon', 'Superior Pulse Cannon|Superior Pulse Cannon|Advanced Laser Cannon|Advanced Laser Cannon|Advanced Freezing Blaster|Advanced Freezing Blaster','40000|50')," +
