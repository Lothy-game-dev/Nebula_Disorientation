...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            ...
            "(2, 'OFF', 'Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed & rotation speed to 0.5x.', 'DPH-1000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '30000', '75', null, 1, '#36b37e' ,'Quickly Charging then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
            "(3, 'OFF', 'Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-1500|AoH-10|AoE-50|V-750|R-1500|DC-0,30', '30000', '75', null, 1, '#36b37e', 'Spawn dozens of rockets that track down enemies nearby. Priority: Enemy Fighter nearest to the player.')," +
            ...
            "(5, 'DEF', 'Fortified Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). <br>Barrier HP now is equaled to 50% of Fighters HP. (Passive Buff).', 'BR-50|BR-x2|DC-10,20', '100000', '300', 1, 5, '#4c9aff', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 100% of Fighter''s HP. (Passive Buff)')," +
            "(6, 'OFF', 'Enhanced Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed & rotation speed to 0.5x.', 'DPH-2000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '100000', '300', 2, 5, '#4c9aff', 'Quickly Charging then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
            "(7, 'OFF', 'Enhanced Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-2000|AoH-20|AoE-75|V-750|R-2000|DC-0,30', '100000', '300', 3, 5, '#4c9aff', 'Spawn dozens of rockets that track down enemies nearby. Priority: Enemy Fighter nearest to the player.')," +
            ...
            "(9, 'DEF', 'Heavy Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). <br>Barrier HP now is equaled to 100% of Fighters HP. (Passive Buff).', 'BR-100|BR-x2|DC-10,20', '300000', null, 5, 13, '#ff0d11', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 100% of Fighter''s HP. (Passive Buff)')," +
            "(10, 'OFF', 'Superior Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed & rotation speed to 0.5x.', 'DPH-3000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '300000', null, 6, 13, '#ff0d11', 'Quickly Charging then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
        ...
        string FactoryModel = "INSERT INTO FactoryModel VALUES " +
            ...
            "(14, 'ND-MKZ', '', 'HP-40000|SPD-600|ROT-1|AOF-120,120|DM-1.25|AM-1.0|PM-0.8|SP-2|SC-4', '250000 | 1500', 17, '#ff0d11', 'ND-Zartillery is the second version of the Elite Fighter Prototypes. It possesses awesome Firepower Damage Implementation & superior Firepower Area of Effect Implementation, at the cost of both Vehicle Structure Health and Movement Speed. It is also equipped with one extra Power Slot.'); ";
        // RankSystem
