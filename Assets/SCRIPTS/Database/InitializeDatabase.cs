...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string Attribute = "INSERT INTO Attribute VALUES " +
                           ...
                           "(11, 'Slot', 'P: Max Special Powers can be equipped.C: Max Consumables can be equipped.')," +
                           "(12, 'Overheat: x | y | z', 'Heat Value starts at 0. When it reaches 100, the Overheat effect is applied - can’t shoot.Overheat = 0: No Overheating.x: Each shot fired increases Heat Value by x.y: Time in sec after not firing that Heat Value will start to decrease(20 points per sec)z: Overheat duration in sec. (After it ends, Heat Value goes back to 0.)')," +
