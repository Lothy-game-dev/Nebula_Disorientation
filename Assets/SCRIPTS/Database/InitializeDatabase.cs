...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            ...
            "(5, 'DEF', 'Fortified Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 100% of Fighter’s HP. (Passive Buff).', 'BR-100|BR-x2|DC-10,20', '25000', '100', 1, 5, '#4c9aff', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 30% of Fighter’s HP. (Passive Buff)')," +
            "(6, 'OFF', 'Enhanced Short Laser Beam', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed to 0.5x. ', 'DPH-2000|AoH-15/s|AoE-25|V-100000|R-750|DC-2.15,20', '25000', '100', 2, 5, '#4c9aff', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
            ...
            "(9, 'DEF', 'Heavy Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 200% of Fighter’s HP. (Passive Buff).', 'BR-200|BR-x2|DC-10,20', '75000', null, 5, 13, '#ff0d11', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 60% of Fighter’s HP. (Passive Buff)')," +
            "(10, 'OFF', 'Superior Short Laser Beam', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed to 0.5x. ', 'DPH-3000|AoH-15/s|AoE-25|V-100000|R-750|DC-2.15,20', '75000', null, 6, 13, '#ff0d11', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
        ...
        string Enemy = "INSERT INTO Enemies VALUES " +
            "(1, 'ZatSBB', 'WSSS', 'SuicideBombing', 'HP-3000|SPD-700|ROT-0.75|AOF-0|DM-0|AM-0|PM-0', '', 'N', 'ZatSBBs are the suicide bombing Fighters of the Zaturi. They sacrifice their lives by ramming into enemy’s Warships and Space Stations, dealing notable DMG doing so.', '#36b37e')," +
            "(2, 'ZatFT-MK1', '', 'AdvancedPulseCannon', 'HP-10000|SPD-500|ROT-0.75|AOF-90,90|DM-1.0|AM-1.0|PM-1.0', 'SituationalBarrier', 'N', 'ZatFTs are the first common Fighters ever widely manufactured by the UEC. They are equipped with Situational Barrier.', '#36b37e')," +
            "(3, 'ZatFT-MK2', '', 'AdvancedNanoFlameThrower', 'HP-8000|SPD-600|ROT-0.75|AOF-90,90|DM-1.0|AM-1.0|PM-1.0', 'SituationalBarrier', 'N', 'MK2 version of the ZatFT exchanges Vehicle Structure Health for Faster Movement Speed. They are equipped with Situational Barrier.', '#36b37e')," +
            "(4, 'ZatFT-MK3', '', 'BlastCannon', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.0|AM-1.0|PM-1.0', 'SituationalBarrier', 'N', 'MK3 version of the ZatFT gets sturdier Vehicle Structure Health at the cost of Movement Speed. They are equipped with Situational Barrier.', '#36b37e')," +
            "(5, 'ZatWR-MK1', '', 'LaserCannon', 'HP-12000|SPD-500|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-1.0', 'FortifiedBarrier', 'N', 'ZatWR prototypes are the advanced Fighters of the Zaturi, with better overall characteristics compared to the ZatFT prototypes, equipped with Fortified Barrier. Their design tends to focus on better Firepower Damage Implementation, resulting in dealing more DMG from weapons.' , '#4c9aff')," +
            "(6, 'ZatWR-MK2', '', 'FreezingBlaster', 'HP-9600|SPD-600|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK2 version of the ZatWR exchanges Vehicle Structure Health for Faster Movement Speed.', '#4c9aff')," +
            "(7, 'ZatWR-MK3', '', '	AdvancedLaserCannon', 'HP-14400|SPD-400|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK3 version of the ZatWR gets sturdier Vehicle Structure Health at the cost of Movement Speed.', '#4c9aff')," +
            "(8, 'ZatWR-MKL', '', 'AdvancedLaserCannon|OrbOfVaccumGenerator', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-0.8', 'FortifiedBarrier|EnhancedRocketBurstDevice', 'N', 'MKL version - the most refined prototype of the ZatWR. It has an advanced Power Activating Module that lowers Power Cooldown and equipped with Enhanced Short Laser Beam as a 2nd Power. However, its turning speed is quite sluggish. ', '#4c9aff')," +
            "(9, 'KazaT-MK1', '', 'LaserCannon', 'HP-12000|SPD-500|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-1.0', 'FortifiedBarrier', 'N', 'KazaT prototypes are the advanced Fighters of the ZatWR, with better overall characteristics compared to the ZatFT prototypes, equipped with Fortified Barrier. Their design tends to focus on better Firepower Area of Effect Implementation, resulting in having better AOE using weapons.', '#4c9aff')," +
            "(10, 'KazaT-MK2', '', 'OrbofLavaGenerator', 'HP-9600|SPD-600|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK2 version of the KazaT exchanges Vehicle Structure Health for Faster Movement Speed.', '#4c9aff')," +
            "(11, 'KazaT-MK3', 'WSSS', 'GravitationalArtillery', 'HP-14400|SPD-400|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-1.0', 'FortifiedBarrier', 'N', 'MK3 version of the KazaT gets sturdier Vehicle Structure Health at the cost of Movement Speed.', '#4c9aff')," +
            "(12, 'KazaT-MKL', 'WSSS', 'AdvancedLaserCannon|GravitationalArtillery', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.0|AM-2.0|PM-0.8', 'FortifiedBarrier|EnhancedShortLaserBeam', 'N', 'MKL version - the most refined prototype of the Kazat. It has an advanced Power Activating Module that lowers Power Cooldown and equipped with Enhanced Short Laser Beam as a 2nd Power. However, its turning speed is quite sluggish.', '#4c9aff')," +
            "(13, 'Zaturi-Prot No.1', 'WSSS', 'NanoCannon|SuperiorLaserCannon', 'HP-30000|SPD-500|ROT-1.25|AOF-120,120|DM-1.15|AM-1.0|PM-0.5', 'HeavyBarrier|SuperiorShortLaserBeam', 'N', 'Zaturi-Prototype No 1 is the first Elite Fighter Prototype by the Zaturi, with better overall characteristics compared to all lower-grade Fighters. It is extremely flexible at turning, having a wider  Arc of Fire. On the other hand, it also has great Firepower Damage Implementation & the best Power Activating Module, together with Heavy Barrier & Superior Short Laser Beam equipped.', '#bf2600')," +
            "(14, 'Zaturi-Ranger', 'WSSS', 'GrandGravitationalArtillery', 'HP-20000|SPD-400|ROT-0.25|AOF-45,45|DM-1.2|AM-3.0|PM-1.0', 'HeavyBarrier|SuperiorRocketBurstDevice', 'N', 'Zaturi-Ranger is the second version of the Elite Fighter Prototypes by the Zaturi. It possesses awesome Firepower Damage Implementation & superior Firepower Area of Effect Implementation, at the cost of both Vehicle Structure Health and Movement Speed. Its Powers are Heavy Barrier & Superior Rocket Burst Device.', '#bf2600')," +
       ...
       string SpaceStation = "INSERT INTO SpaceStation VALUES" +
        ...
        string Allies = "INSERT INTO Allies VALUES " +
            ...
            "(8, 'SSS-MKL', '', 'AdvancedLaserCannon|OrbofVaccumGenerator', 'HP-12000|SPD-400|ROT-0.75|AOF-90,90|DM-1.1|AM-1.0|PM-0.8', 'FortifiedBarrier|EnhancedRocketBurstDevice', '#4c9aff')," +
            ...
            "(12, 'UEC29-MKL', 'WSSS', 'AdvancedLaserCannon|GravitationalArtillery', 'HP-12000|SPD-400|ROT-0.5|AOF-90,90|DM-1.0|AM-2.0|PM-0.8', 'FortifiedBarrier|EnhancedShortLaserBeam', '#4c9aff')," +
