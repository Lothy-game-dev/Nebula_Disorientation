...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDataDatabase()
    {
        ...
        string ArsenalWeapon = "INSERT INTO ArsenalWeapon VALUES " +
            ...
            "(5, 'Thermal', 'Advanced Nano Flame Thrower', 'An upgraded edition of the Nano Flame Thrower, which now emits a yellow flame with a red aura.', 'OH-0.067,4,15|DPH-15|RoF-150|AoE-0|V-750|R-500', '5000', '35', 4, 1, '#36b37e', 'Yellow', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>DADDD - An upgraded edition of the Nano Flame Thrower, which now emits a yellow flame with a red aura.')," +
            "(6, 'Thermal', 'Superior Nano Flame Thrower ', 'The most powerful version of the Nano Flame Thrower.', 'OH-0.067,4,20|DPH-20|RoF-125|AoE-0|V-750|R-500', '15000', '50', 5, 1, '#36b37e', 'Yellow', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>DADDD - The most powerful version of the Nano Flame Thrower.')," +
            "(7, 'Kinetic', 'Blast Cannon', 'A cannon that fires large, yellow bullets.', 'OH-4,2,10|DPH-700|RoF-2|AoE-100|V-1250|R-1750,2000', '5000', '25', 1, 1, '#36b37e', 'White', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>CCCCC - A cannon that fires large, yellow bullets.')," +
            "(8, 'Kinetic', 'Grand Blast Cannon', 'An advanced version of the Blast Cannon. It now shoots light blue bullets.', 'OH-4,2,10|DPH-1000|RoF-2|AoE-125|V-1250|R-1750,2000', '15000', '50', 7, 1, '#36b37e', 'Light Blue', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>CCCCC - An advanced version of the Blast Cannon. It now shoots light blue bullets.')," +
            ...
            "(10, 'Thermal', 'Freezing Blaster', 'A powerful thermal weapon that emits a straight beam of blue freezing ice.', 'OH-0.067,2,10|DPH-30|RoF-150|AoE-0|V-750|R-600', '35000', '200', null, 5, '#4c9aff', 'Blue', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>DADDD - A powerful thermal weapon that emits a straight beam of blue freezing ice.')," +
            "(11, 'Thermal', 'Advanced Freezing Blaster', 'An upgraded edition of the Freezing Blaster, which now emits a beam of light blue ice.', 'OH-0.067,2,10|DPH-45|RoF-150|AoE-0|V-750|R-600', '50000', '225', 10, 5, '#4c9aff', 'Light Blue', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>CADDD - An upgraded edition of the Freezing Blaster, which now emits a beam of light blue ice.')," +
            "(12, 'Laser', 'Laser Cannon', 'A laser-powered weapon that shoots light-red laser projectiles.', 'OH-2,1,10|DPH-600|RoF-4|AoE-0|V-2000|R-2500', '35000', '200', null, 5, '#4c9aff', 'Light Red', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>BADAB - A laser-powered weapon that shoots light-red laser projectiles.')," +
            "(13, 'Laser', 'Advanced Laser Cannon', 'An advanced version of the Laser Cannon. It now shoots pure red laser projectiles.', 'OH-2,1,10|DPH-900|RoF-4|AoE-0|V-2000|R-2500', '50000', '225', 12, 5, '#4c9aff', 'Red', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>BADAB - An advanced version of the Laser Cannon. It now shoots pure red laser projectiles.')," +
            ...
            "(19, 'Laser', 'Superior Laser Cannon', 'The top-tier version of the Laser Cannon. It now shoots much refined red laser projectiles.', 'OH-2,1,10|DPH-2000|RoF-4|AoE-0|V-1750|R-2500', '200000', 500, 13, 13, '#ff0d11', 'Dark Red', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>BBDAB - The top-tier version of the Laser Cannon. It now shoots much refined red laser projectiles.')," +
            "(20, 'Laser', 'Plasma Cannon', 'Nano Cannon can penetrate all enemies within 500 SU at point blank. <br>A Plasma version of the Nano Cannon. ', 'OH-1,2,10|DPH-900|RoF-8|AoE-0|V-2000|R-2250', '100000', 500, 16,13, '#ff0d11', 'White', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>BADBB - Nano Cannon can penetrate all enemies within 500 SU at point blank. <br>A Plasma version of the Nano Cannon. ')," +
            "(21, 'Thermal', 'Nano Effect Analyzer', 'A high-level cannon that amplifies the power of Thermal Status. <br>Detailed: Encyclopedia - Damage Element', 'OH-1,4,10|DPH-150|RoF-4|AoE-0|V-2000|R-2500', '100000', 400, 16, 13, '#ff0d11', 'White', 'A-D (Good-Bad) | DPH-ROF-AOE-VELO-RANGE<br><br>DCDAB - A high-level cannon that amplifies the power of Thermal Status. <br>Detailed: Encyclopedia - Damage Element')," +
