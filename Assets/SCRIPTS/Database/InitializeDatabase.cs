...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            ...
            "(5, 'DEF', 'Fortified Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). <br>Barrier HP now is equaled to 50% of Fighters HP. (Passive Buff).', 'BR-50|BR-x2|DC-10,20', '25000', '100', 1, 5, '#4c9aff', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 100% of Fighter''s HP. (Passive Buff)')," +
            ...
            "(9, 'DEF', 'Heavy Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). <br>Barrier HP now is equaled to 100% of Fighters HP. (Passive Buff).', 'BR-100|BR-x2|DC-10,20', '75000', null, 5, 13, '#ff0d11', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 100% of Fighter''s HP. (Passive Buff)')," +
