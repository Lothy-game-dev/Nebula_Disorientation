...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            ...
            "(2, 'OFF', 'Short Laser Beam', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed to 0.5x. ', 'DPH-1000|AoH-10/s|AoE-25|V-100000|R-750|DC-3,20', '0', '0', null, 1, '#36b37e' ,'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
            "(3, 'OFF', 'Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-1500|AoH-10|AoE-50|V-5000|R-1500|DC-0,30', '3000', '50', null, 1, '#36b37e', 'Spawn dozens of rockets that track down enemies nearby. Priority: Enemy Fighter nearest to the player.')," +
            ...
            "(5, 'DEF', 'Fortified Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 30% of Fighter’s HP. (Passive Buff).', 'BR-30|BR-x2|DC-10,20', '10000', '150', 1, 5, '#4c9aff', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 30% of Fighter’s HP. (Passive Buff)')," +
            "(6, 'OFF', 'Enhanced Short Laser Beam', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown movement speed to 0.5x. ', 'DPH-2000|AoH-10/s|AoE-25|V-100000|R-750|DC-3,20', '15000', '150', 2, 5, '#4c9aff', 'Charging for 3 secs, then shoot out a powerful beam of laser in front for a quick span of time. While shooting, slowdown movement speed to 0.5x. ')," +
            "(7, 'OFF', 'Enhanced Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-2000|AoH-20|AoE-75|V-5000|R-2000|DC-0,30', '15000', '150', 3, 5, '#4c9aff', 'Spawn dozens of rockets that track down enemies nearby. Priority: Enemy Fighter nearest to the player.')," +
            ...
            "(9, 'DEF', 'Heavy Barrier', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 60% of Fighter’s HP. (Passive Buff).', 'BR-60|BR-x2|DC-10,20', '30000', null, 5, 9, '#bf2600', 'Double the Barrier HP. (Current HP and Curent Max HP). Barrier HP now is equalled to 60% of Fighter’s HP. (Passive Buff)')," +
