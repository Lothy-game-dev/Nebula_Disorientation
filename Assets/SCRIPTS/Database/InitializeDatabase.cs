...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDataDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            "(1, 'DEF', 'Situational Barrier', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 2000.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>', 'BR-x2|DC-10,20', '0', '0', null, 1, '#36b37e', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 2000.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>')," +
            ...
            "(3, 'OFF', 'Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-1500|AoH-10|AoE-50|V-750|R-1500|DC-0,30', '30000', '75', null, 1, '#36b37e', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player')," +
            ...
            "(5, 'DEF', 'Fortified Barrier', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 50% of Fighter’s Base HP.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>', 'BR-50|BR-x2|DC-10,20', '100000', '300', 1, 5, '#4c9aff', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 50% of Fighter’s Base HP.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>')," +
            "(6, 'OFF', 'Enhanced Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.', 'DPH-2000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '100000', '300', 2, 5, '#4c9aff', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.')," +
            "(7, 'OFF', 'Enhanced Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-2000|AoH-20|AoE-75|V-750|R-2000|DC-0,30', '100000', '300', 3, 5, '#4c9aff', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player')," +
            "(8, 'MOV', 'Boosted Instant Wormhole', 'Teleport forward for a distance.', 'DPH-null|AoH-null|AoE-null|V-null|R-1000|DC-0,30', '100000', '300', 4, 5, '#4c9aff', 'Teleport forward for a distance.')," +
            "(9, 'DEF', 'Heavy Barrier', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 100% of Fighter’s Base HP.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>', 'BR-100|BR-x2|DC-10,20', '300000', null, 5, 13, '#ff0d11', '<color=green>Activation Effect</color>:<br>Double the Barrier Max HP & Add 100% Base Barrier HP to Current Barrier HP.<br><br><color=#0096FF>Passive Effect</color>:<br>Base Barrier HP = 100% of Fighter’s Base HP.<br><br><color=#3bccec>Fighter Barrier has +<color=green>75%</color> Resistance against Powers and +<color=green>25%</color> Resistance against Normal Weapons.</color>')," +
            "(10, 'OFF', 'Superior Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x. ', 'DPH-3000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '300000', null, 6, 13, '#ff0d11', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.')," +
            "(11, 'OFF', 'Superior Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-3000|AoH-30|AoE-100|V-1000|R-2500|DC-0,30', '300000', null, 7, 13, '#ff0d11', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player')," +
            "(12, 'MOV', 'Advanced Instant Wormhole', 'Teleport forward for a distance.', 'DPH-null|AoH-null|AoE-null|V-null|R-1000|DC-0,5', '300000', null, 8, 13, '#ff0d11', 'Teleport forward for a distance.'); ";
        // FactoryModel
