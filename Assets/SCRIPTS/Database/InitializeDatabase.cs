...
public class InitializeDatabase : MonoBehaviour
{
    ...
    public void CreateDataDatabase()
    {
        ...
        string ArsenalPower = "INSERT INTO ArsenalPower VALUES " +
            ...
            "(2, 'OFF', 'Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.', 'DPH-1000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '30000', '75', null, 1, '#36b37e' ,'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.')," +
            "(3, 'OFF', 'Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-1500|AoH-10|AoE-50|V-750|R-1250|DC-0,30', '30000', '75', null, 1, '#36b37e', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player')," +
            "(4, 'MOV', 'Instant Wormhole', 'Teleport forward for a distance.', 'DPH-null|AoH-null|AoE-null|V-null|R-1000|DC-0,30', '30000', '75', null, 1, '#36b37e', 'Teleport forward for a distance.')," +
            ...
            "(6, 'OFF', 'Enhanced Short Laser Beam', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.', 'DPH-2000|AoH-15/s|AoE-25|V-1500|R-750|DC-2.15,20', '100000', '200', 2, 5, '#4c9aff', 'Charging for 1.14 secs, then shoot out a powerful beam of laser in front for a quick span of time.<br>Detailed: While shooting, slowdown rotation speed to 0.5x.')," +
            "(7, 'OFF', 'Enhanced Rocket Burst Device', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player', 'DPH-2000|AoH-20|AoE-75|V-750|R-1500|DC-0,30', '100000', '200', 3, 5, '#4c9aff', 'Spawn dozens of rockets that track down enemies nearby.<br>Priority: Enemy Fighter nearest to the player')," +
            "(8, 'MOV', 'Boosted Instant Wormhole', 'Teleport forward for a distance.', 'DPH-null|AoH-null|AoE-null|V-null|R-1000|DC-0,30', '100000', '200', 4, 5, '#4c9aff', 'Teleport forward for a distance.')," +
