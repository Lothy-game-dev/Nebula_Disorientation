            ...
            if (als.DelayTimer < 0f && !als.LeftFire)
            {
                ...
                LeftWeapon.AIShootBullet((float)(als.LeftTarget != null && als.LeftTarget.GetComponent<SpaceStationShared>() == null ?
                    ...
                    * (als.LeftTarget != null && als.LeftTarget.GetComponent<SpaceStationShared>() == null ?
                    (als.LeftTarget.GetComponent<PlayerMovement>() != null ? als.LeftTarget.GetComponent<PlayerMovement>().CurrentSpeed > 0 ? als.LeftTarget.GetComponent<PlayerMovement>().CurrentSpeed : 400
                    : als.LeftTarget.GetComponent<FighterMovement>() != null ? als.LeftTarget.GetComponent<FighterMovement>().CurrentSpeed > 0 ? als.LeftTarget.GetComponent<FighterMovement>().CurrentSpeed : 400
                    : als.LeftTarget.GetComponent<WSMovement>() != null ? als.LeftTarget.GetComponent<WSMovement>().CurrentSpeed > 0 ? als.LeftTarget.GetComponent<WSMovement>().CurrentSpeed : 400 : 400) : 400) / 350f
                    * 15);
