...
public class SessionArsenalButton : MonoBehaviour
{
    ...
    private SessionArsenal ArsenalController;
    #endregion
    #region Start & Update
    ...
    void Start()
    {
        ...
        ArsenalController = Arsenal.GetComponent<SessionArsenal>();
    }
    ...
    private void OnMouseDown()
    {
        ...
        if ("Weapon" == gameObject.name)
        {
            ...
            for (int i = 0; i < ArsenalController.WeaponList.Count; i++)
            {
                ...
                g.GetComponent<SessionArsenalItem>().Id = ArsenalController.WeaponList[i][0];
                ...
                if (i == 0)
                {
                    g.GetComponent<SessionArsenalItem>().ArsenalInformation(ArsenalController.WeaponList, "1");
        ...
        else
        {
            if ("Power" == gameObject.name)
            {
                ...
                for (int i = 0; i < ArsenalController.PowerList.Count; i++)
                {
                    ...
                    g.GetComponent<SessionArsenalItem>().Id = ArsenalController.PowerList[i][0];
                    g.GetComponent<SessionArsenalItem>().Type = "Power";
                    g.GetComponent<SessionArsenalItem>().ItemStatusList = PowerStatus;
                    g.GetComponent<SessionArsenalItem>().Content = Content;
                    g.GetComponent<SessionArsenalItem>().ArItemList = ArsenalController.PowerList;
                    ...
                    if (i == 0)
                    {
                        g.GetComponent<SessionArsenalItem>().ArsenalInformation(ArsenalController.PowerList, "1");
                    }
                }
